...
- **Reported:** 2026-06-07 (Mark QQ: "are Shuck the Oyster listings accurate?") · **Type:** Scrape completeness · **Severity:** 3 · **Surface:** `shucktheoyster_scraper.py` (`MAX_LISTING_PAGES = 50`) · **Status:** Open — full-site sweep running to size the gap; cap fix to follow.
