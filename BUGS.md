...
### B-24 — Bonhams direct residential scrape, schedule-driven (plan thread, scoped & ready to build)
- **Reported:** 2026-05-26 · **Type:** Plan/build thread · **Status:** Open — scoped; ready to build next session.
...
### B-25 — Residential scrape host: laptop now → Raspberry Pi / Mac mini (plan thread)
- **Reported:** 2026-05-26 · **Type:** Plan/infra thread · **Status:** Open — the host for B-24 (and possibly TW).
