...
const node = {
  ...
  guides: [
    ...
    },
    {
      ...
      img: "",
      blurb: "Where you start learning to see a 5513 properly. Not a broad history but a dial study, which is exactly why it's useful. Meters-first, serif, non-serif, Maxi, pre-COMEX: spend time here and you start noticing what collectors actually talk about: typography, plot size, spacing, sequence, and how small dial changes reshape the whole watch.",
  ...
  connections: [
    ...
    { label: "Cartier Tank", distance: "edge", why: "Not because it looks like a 5513, but because collectors drawn to timeless design, proportion and objects that outlive trends often end up appreciating both.", match: { text: ["tank"], brand: "cartier" } },
  ],
