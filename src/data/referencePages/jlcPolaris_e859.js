...
const node = {
  ...
  connections: [
    ...
    { label: "Longines Legend Diver lineage", distance: "similar", why: "The same EPSA super-compressor case and internal-bezel logic in Longines' idiom, and the front door to the whole compressor rabbit hole.", match: { brand: "longines", text: ["legend diver", "7042", "7150"] } },
    { label: "Universal Genève Polerouter Sub", distance: "similar", why: "Compressor case, collector appeal, and an introduction to UG collecting, all without leaving the adventure world.", match: { brand: "universal", text: ["polerouter"] } },
  ...
  storiesAndImages: [
    ...
    { title: "Introducing the 2018 Polaris collection at SIHH", publication: "Monochrome", url: "https://monochrome-watches.com/jaeger-lecoultre-polaris-2018-collection-sihh-2018-memovox-automatic-date-chronograph-price/", img: "https://monochrome-watches.com/wp-content/uploads/2018/01/Jaeger-LeCoultre-Polaris-Memovox-2018-ref-9038670-13.jpg" },
    { title: "Hands-on: the Polaris Mariner Memovox, the alarm back at 300m", publication: "Fratello", url: "https://www.fratellowatches.com/hands-on-jaeger-lecoultre-polaris-mariner-memovox-review/", img: "https://www.fratellowatches.com/cdn-cgi/image/anim=false/wp-content/uploads/2020/10/JLC-EMBARGO-Mariner-Memovox-15.jpg" },
