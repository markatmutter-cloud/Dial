...
const node = {
  ...
  connections: [
    { label: "Rolex Milgauss 1019", distance: "similar", why: "Not because it looks similar, but because it answers exactly the same problem: a watch for people who work near magnetic fields.", match: { brand: "rolex", text: ["milgauss"] } },
    ...
    { label: "Omega Speedmaster", distance: "adjacent", why: "The third leg of the trilogy, and the broader Omega tool story the Railmaster belongs to.", match: { brand: "omega", text: ["speedmaster"] } },
